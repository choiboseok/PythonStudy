...
try :
    ...
    messagebox.showinfo('라이브러리 에러', 'reportlab 설치되어 있지 않습니다.')
...
def open_file():
    ...
    if file_path:
        ...
        content = f.read()
        f.close()
        text_area.delete('1.0', END) # 기존 메모장 내용 삭제
        text_area.insert('1.0', content) # 불러온 메모장 내용 추가
